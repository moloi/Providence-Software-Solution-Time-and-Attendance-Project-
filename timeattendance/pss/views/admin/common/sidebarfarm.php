    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div><a href="javascript:void(0);" class="btn btn-success btn-lg_1 btn-block_half fancybox.ajax" id="add_farm" clientid = "<?php echo substr(base_url(uri_string()), strrpos(base_url(uri_string()), "/")+1); ?>" title="Add Farm">Add Farm</a></div>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">

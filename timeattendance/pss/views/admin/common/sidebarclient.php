    <?php if(admin_in()){ ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div><a href="javascript:void(0);" class="btn btn-success btn-lg_1 btn-block_half fancybox.ajax" id="add_client" title="Add Client">Add Client</a></div>
                <div><a href="#" class="btn btn-success btn-lg_1 btn-block_half">Add Shapefile</a></div>
            </div>
        </div>
    <?php } ?>
    <div class="panel panel-default">

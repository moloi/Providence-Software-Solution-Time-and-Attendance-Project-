                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <?php endif; ?>
                            ...
                            <h3 class="box-title" style="float:right;color:white !important;"><a style="color:white !important;" class="btn btn-primary" href="<?php echo HTTP_PATH."userroles/form" ?>"><i class="fa fa-plus-square-o"></i> Add</a>
                        </div>
